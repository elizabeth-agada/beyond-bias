...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <header className="fixed w-full z-50 bg-black/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8 items-center">
            ...
            <NavLink
              href="#donate"
              className="inline-block bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-md font-medium transition"
            >
              Donate
            </NavLink>
          </nav>
          <button className="md:hidden text-white p-2" onClick={() => setMobileMenuOpen(true)} aria-label="Open menu">
      ...
      >
        <div
          className={`absolute top-0 right-0 h-full w-4/5 max-w-xs bg-black border-l border-white/20 transform transition-transform duration-300 ease-in-out ${
        ...
        >
          <div className="p-5">
            <div className="flex justify-between items-center mb-8">
              ...
              <button className="text-white" onClick={() => setMobileMenuOpen(false)} aria-label="Close menu">
                <X className="h-6 w-6" />
              </button>
            </div>
            <nav className="flex flex-col space-y-6">
              ...
              <MobileNavLink href="#journey" onClick={() => setMobileMenuOpen(false)}>
                Our Journey
              </MobileNavLink>
              ...
              <MobileNavLink
                href="#donate"
                onClick={() => setMobileMenuOpen(false)}
                className="inline-block bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-md font-medium transition text-center"
              >
                Donate
              </MobileNavLink>
            </nav>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-lg sm:text-xl md:text-2xl mb-8 italic">
              &quot;There is Space For You Here.&quot; - S. Minhas
            </p>
            <div className="w-24 h-1 bg-[#D4AF37] mx-auto my-8 md:my-12"></div>
            <div className="mt-8 md:mt-12">
              <h2 className="text-xl sm:text-2xl font-bold text-[#D4AF37] mb-4">Mission</h2>
              <p className="text-base sm:text-lg md:text-xl mb-8 md:mb-12 px-2">
                We are on a mission to uplift underrepresented youth by breaking down systemic barriers and expanding
                access to education, mentorship, and empowering career opportunities, so every child has a real chance
                to succeed and lead
              </p>
              <h2 className="text-xl sm:text-2xl font-bold text-[#D4AF37] mb-4">Vision</h2>
              <p className="text-base sm:text-lg md:text-xl px-2">
                ...
                opportunities to thrive—building a future that&apos;s diverse, inclusive, and driven by empowered
                leaders from every background
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="journey" className="py-16 md:py-20 bg-zinc-900">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start mt-12 md:mt-16">
            <div className="space-y-6">
              <p className="text-lg md:text-xl text-white/90">
                At Beyond Bias Foundation, we believe every child deserves the chance to thrive, no matter where
                they&apos;re born.
              </p>
              ...
              <div className="pt-4">
                <a
                  ...
                  className="inline-block bg-[#D4AF37] hover:bg-[#D4AF37]/90 text-black font-medium px-6 py-3 rounded-md transition"
                >
            ...
            <div className="flex justify-center mt-8 md:mt-0">
              <div className="relative max-w-md overflow-hidden rounded-lg border-4 border-[#D4AF37]/30">
                <Image
      ...
      <section id="how-it-works" className="py-16 md:py-20 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 mt-12 md:mt-16">
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-6 md:mb-8 text-[#D4AF37]">Sponsorship Model:</h3>
              <ul className="space-y-6">
                <li className="flex items-start">
                  <div className="text-[#D4AF37] mr-4 text-2xl">•</div>
                  <p className="text-base md:text-lg text-white/90">Sponsor a child monthly or yearly</p>
                </li>
                <li className="flex items-start">
                  <div className="text-[#D4AF37] mr-4 text-2xl">•</div>
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-6 md:mb-8 text-[#D4AF37]">What&apos;s Included:</h3>
              <ul className="space-y-6">
                <li className="flex items-start">
                  <div className="text-[#D4AF37] mr-4 text-2xl">•</div>
                  <div>
                    <span className="text-base md:text-lg font-semibold text-white">Education: </span>
                ...
                <li className="flex items-start">
                  <div className="text-[#D4AF37] mr-4 text-2xl">•</div>
                  <div>
                    <span className="text-base md:text-lg font-semibold text-white">Housing: </span>
                    <span className="text-base md:text-lg text-white/90">
                      Safe, stable accommodation with a host family
                    </span>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="text-[#D4AF37] mr-4 text-2xl">•</div>
                  <div>
                    <span className="text-base md:text-lg font-semibold text-white">Mentorship: </span>
                    <span className="text-base md:text-lg text-white/90">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white">
                Your Impact: Changing Lives Through Education
              </h2>
              <p className="text-lg sm:text-xl md:text-2xl mb-8 text-gray-300">
                See how your support is shaping the future
              </p>
              <div className="grid grid-cols-2 gap-4 sm:gap-8 text-center mt-8 md:mt-12">
                <div className="p-4 sm:p-6 bg-gray-900 rounded-lg border border-red-600">
                  <div className="text-3xl sm:text-4xl font-bold text-red-600 mb-2">95%</div>
                  <p className="text-base sm:text-lg text-white">Graduate Rate</p>
                </div>
                <div className="p-4 sm:p-6 bg-gray-900 rounded-lg border border-red-600">
                  <div className="text-3xl sm:text-4xl font-bold text-red-600 mb-2">10</div>
                  <p className="text-base sm:text-lg text-white">Years of Impact</p>
                </div>
              </div>
              <div className="mt-8 md:mt-12">
                <Link
                  href="/impact"
                  className="inline-block bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-md font-medium transition"
                >
            ...
            <div className="order-1 md:order-2">
              <div className="w-full h-64 sm:h-80 md:h-96 bg-gray-800 rounded-lg flex items-center justify-center">
                <Image
                  src="/img/impact.jpg"
                  alt="Impact Image"
                  width={500}
      ...
      <section className="py-12 md:py-16 bg-black">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 md:mb-12 text-center text-white">
            Hear from Our Students for 2025
          </h2>
          ...
          <div className="space-y-12 md:space-y-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
              ...
              <div className="order-2">
                <p className="text-base sm:text-lg md:text-xl text-gray-300">
                  13-year-old Massiah from Gembu, Nigeria, lost his mother at birth and has been raised in poverty by
                  his father. Despite the odds, he dreams of going to school. With your sponsorship, Massiah can access
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
              <div className="order-2 md:order-1">
                <p className="text-base sm:text-lg md:text-xl text-gray-300">
                  At 14, Muri has faced abandonment and hardship, raised by his hardworking mother who farms to support
                  them. Sponsorship would open the door to education, giving Muri a path to a brighter future and easing
                  his mother&apos;s load.
                </p>
                <div className="mt-6">
                  <Link
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
              ...
              <div className="order-2">
                <p className="text-base sm:text-lg md:text-xl text-gray-300">
                  6-year-old Kindness comes from a caring but struggling family. With her mother recently ill, finances
                  are tight, and school is out of reach. Your sponsorship can give Kindness the education she deserves.
                </p>
                <div className="mt-6">
                  <Link
                    href="/#donate"
          ...
          <div className="mt-12 md:mt-16 text-center">
            <a
              href="/students"
              className="inline-block border-2 border-[#D4AF37] hover:bg-[#D4AF37] hover:text-black text-[#D4AF37] px-6 py-3 rounded-md font-medium transition"
            >
              Meet More Students
            </a>
          </div>
      ...
      <section className="py-16 md:py-20 bg-black">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-center text-white mb-10 md:mb-16">
      ...
      <section id="donate" className="py-12 md:py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">Donate Now!</h2>
              <p className="text-lg sm:text-xl mb-6">
                &quot;Your donation helps us fund scholarships, mentorship sessions, and provide resources to
                underserved students.&quot;
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="bg-white text-black bg-opacity-10 p-4 sm:p-6 rounded-lg shadow-lg">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 text-center">Sponsorship Options</h3>
                <div className="space-y-4">
                  <div className="border-b border-white border-opacity-20 pb-4">
                    <h4 className="font-bold text-lg sm:text-xl">Monthly Sponsorship - $50/month</h4>
                    <p>Cover a child&apos;s ongoing school and living expenses in full.</p>
                  </div>
                  <div className="border-b border-white border-opacity-20 pb-4">
                    <h4 className="font-bold text-lg sm:text-xl">One-Time Full Year Sponsorship - $600</h4>
                    <p>Sponsor an entire year of education and care with a single donation.</p>
                  </div>
                  <div className="border-b border-white border-opacity-20 pb-4">
                    <h4 className="font-bold text-lg sm:text-xl">One-Time Donation - $100</h4>
                    <p>Contribute toward school fees, supplies, or healthcare — every dollar helps!</p>
                  </div>
                  <div className="border-b border-white border-opacity-20 pb-4">
                    <h4 className="font-bold text-lg sm:text-xl">Back-to-School Kit - $75</h4>
                    <p>Equip a child with essential school supplies, shoes, and hygiene items.</p>
                  </div>
                  <div>
                    <h4 className="font-bold text-lg sm:text-xl">Transport & Meals Support - $35/month</h4>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="bg-white p-4 rounded-lg mb-6 max-w-xs w-full">
                  <Image
                    src="/img/qr.png"
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xl sm:text-2xl font-bold">
                    ...
                    <span className="bg-white text-black bg-opacity-20 px-2 py-2 rounded break-all">
                      Beyonbdiasfoundation@yahoo.com
                    </span>
            ...
            <div className="text-center mt-8 md:mt-12">
              <p className="text-lg sm:text-xl">Your support brings hope, opportunity, and a future full of promise.</p>
              <p className="text-lg sm:text-xl font-bold mt-2">Donate today — and help a child thrive.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-16 md:py-20 bg-black">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 mt-12 md:mt-16">
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-[#D4AF37]">Get In Touch</h3>
              <p className="text-base md:text-lg text-white/80 mb-8">
                Have questions about our programs or want to learn more about how you can support our mission? We&apos;d
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 break-all">Beyonbdiasfoundation@yahoo.com</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-zinc-800 p-6 md:p-8 rounded-lg">
              <h3 className="text-xl md:text-2xl font-bold mb-6 text-[#D4AF37]">Send Us a Message</h3>
